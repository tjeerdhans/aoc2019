...
while (res!=99) {
  ...
  m <- modes(o)
  #print(o)
  #print(c(pointer,op,m))
 #print(m)
  res <- switch (op,
           {
             p1 <- ifelse(length(m)>0 & m[1]==1,ops5[pointer+1],ops5[ops5[pointer+1]+1])
             p2 <- ifelse(length(m)>1 & m[2]==1,ops5[pointer+2],ops5[ops5[pointer+2]+1])
